...
# PREDICTION FOR ONLY THE BEST MODEL
...
if best == 'ARIMA':
    ...
    rmse_models_fitted_vs_true = calc_error(data.total.values[1:], fitted_df_ar.fitted.values[1:],
                                                     method='RMSE', normalized=False)
    ...
    arima_track['rmse'] = rmse_models_fitted_vs_true
...
# ETS
    ...
    rmse_models_fitted_vs_true = calc_error(data.total.values,df_fitted_ets.fitted.values,method='RMSE', normalized=False)
    ...
    ETS_track['type']='ETS'
    ETS_track['rmse']=rmse_models_fitted_vs_true
...
# PROPHET
    ...
    rmse_models_fitted_vs_true = calc_error(data.total.values,df_fitted_pr.fitted.values,method='RMSE', normalized=False)
    ...
    prophet_track['rmse']=rmse_models_fitted_vs_true
